...
exports.runJScript = exports.urlRequire = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    source = _a.sent();
                    return [2, runJScript(source)];
            }
        });
    });
}
exports.urlRequire = urlRequire;
function runJScript(source) {
    var ast = esprima.parseModule(source);
    var result = escodegen_1.default.generate(ast);
    return eval(result);
}
exports.runJScript = runJScript;
